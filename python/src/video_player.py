...
class VideoPlayer:
    ...
    def _set_playing_video(self, video):
    ...
    def show_all_videos(self):
        """Returns all videos."""
        videos = sorted(self._video_library.get_all_videos(), key=lambda k: k.title)
    ...
    def play_video(self, video_id):
        ...
        self._set_playing_video(current_video)
    ...
    def pause_video(self):
        ...
        if self._paused:
            print(f'Video already paused: {self._playing_video}')
            return
    ...
    def show_playing(self):
        ...
        message = f'Currently playing: {self._playing_video}'
        if self._paused:
            message += ' - PAUSED'
        print(message)
